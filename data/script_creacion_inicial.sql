...
CREATE PROCEDURE sp_migrar_frenos_por_medicion
 AS
  BEGIN
	...
	SELECT DISTINCT TELE_AUTO_CODIGO, TELE_FRENO1_NRO_SERIE, TELE_FRENO1_TEMPERATURA
	FROM gd_esquema.Maestra
	WHERE TELE_AUTO_CODIGO IS NOT NULL and TELE_FRENO1_NRO_SERIE IS NOT NULL
	UNION
	SELECT DISTINCT TELE_AUTO_CODIGO, TELE_FRENO2_NRO_SERIE, TELE_FRENO2_TEMPERATURA
	FROM gd_esquema.Maestra
	WHERE TELE_AUTO_CODIGO IS NOT NULL and TELE_FRENO2_NRO_SERIE IS NOT NULL
	UNION
	SELECT DISTINCT TELE_AUTO_CODIGO, TELE_FRENO3_NRO_SERIE, TELE_FRENO3_TEMPERATURA
	FROM gd_esquema.Maestra
	WHERE TELE_AUTO_CODIGO IS NOT NULL and TELE_FRENO3_NRO_SERIE IS NOT NULL
	UNION
	SELECT DISTINCT TELE_AUTO_CODIGO, TELE_FRENO4_NRO_SERIE, TELE_FRENO4_TEMPERATURA
	FROM gd_esquema.Maestra
